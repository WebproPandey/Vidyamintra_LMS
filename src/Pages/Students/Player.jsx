...
const Player = () => {
 ...
 useEffect(() => {
  ...
  return (
    <>
      <div className="p4- sm:p-10 flex flex-col-reverse md:grid  md:grid-cols-2 gap-10 md:px-36">
        {/* left column */}
        <div className="text-gray-800">
          <h1 className="text-xl font-semibold">Courese Structure</h1>
          <div className="pt-5">
              ...
              >
                ...
                <div
                  className={`overflow-hidden  transition-all  duration-300 ${
                    opneSection[index] ? "max-h-96" : " max-h-0"
                  }`}
                >
          ...
          <div className="flex items-center gap-2 py-2 mt-10">
            <h1 className="text font-bold">Rate this Course:</h1>
